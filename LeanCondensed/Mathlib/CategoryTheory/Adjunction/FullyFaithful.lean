...
lemma Adjunction.isIso_counit_of_iso [L.Faithful] [L.Full] {X : D} (i : X ≅ L.obj (R.obj X)) :
...
lemma Adjunction.isIso_unit_of_iso [R.Faithful] [R.Full] {X : C} (i : X ≅ R.obj (L.obj X)) :
